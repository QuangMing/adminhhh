  ...
  <div>
    <page-view :title="title">
      <a-card :bordered="false">
        ...
        <s-table bordered  tableLayout="fixed" ref="table" size="default" rowKey="key" :columns="scheduleColumns" :data="loadScheduleData"
        >
    ...
    >
        ...
        <s-table bordered tableLayout="fixed" ref="table" size="default" rowKey="key" :columns="alertTitle" :data="loadScheduleData" >
            <span slot="serial"  slot-scope="text, record, index">{{ index + 1 }}</span>
            <a slot="name" slot-scope="text">{{ text }}</a>
            <span slot="action" slot-scope="text, record">
            <template>
                  <a @click="handleEdit(record)"> <a-icon type="highlight" /></a>
                  <a-divider type="vertical" />
                  <a @click="handleEdit(record)"> <a-icon type="delete" style="color:red" /> </a>
                  <a-divider type="vertical" />
                  <a-button type="primary" size="small" @click="Scoring(true)">评分单据</a-button>
                </template>
          </span>
